# Generated by Django 5.1.3 on 2026-03-30 14:17
...
class Migration(migrations.Migration):
    replaces = [
        ...
        ("pp", "0003_question_question_image"),
        ("pp", "0004_alter_question_question_image"),
        ("pp", "0005_alter_question_question_image"),
        ("pp", "0006_alter_question_question_image"),
        ("pp", "0007_testgroup_questions_amount"),
        ("pp", "0008_alter_testgroup_questions_amount"),
        ("pp", "0009_alter_testgroup_questions_amount"),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "group_name",
                    models.CharField(help_text="E.g. 'Rookies 2024' or 'ERD rules checkup'", max_length=255),
                ),
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=3, verbose_name="How many questions would you like the test to have?"
                    ),
                ),
            ],
            options={
